...
function createArticle(title, date, firstParagraph, secondParagraph, thirdParagraph) {
    ...
    articleContent.appendChild(articleParagraph1)
    articleContent.appendChild(articleParagraph2)
    articleContent.appendChild(articleParagraph3)
    article.appendChild(expandButton)

    article.classList.add('article', 'close')
    articleTitle.classList.add('article-title')
    articleDate.classList.add('date')
    articleParagraph1.classList.add('paragraph-one')
    articleParagraph2.classList.add('paragraph-two')
    articleParagraph3.classList.add('paragraph-three')
